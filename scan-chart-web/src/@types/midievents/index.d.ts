declare module 'midievents' {
	...
	// MIDI event sizes
	const MIDI_1PARAM_EVENTS = [EVENT_MIDI_PROGRAM_CHANGE, EVENT_MIDI_CHANNEL_AFTERTOUCH]
	const MIDI_2PARAMS_EVENTS = [EVENT_MIDI_NOTE_OFF, EVENT_MIDI_NOTE_ON, EVENT_MIDI_NOTE_AFTERTOUCH, EVENT_MIDI_CONTROLLER, EVENT_MIDI_PITCH_BEND]
