 ...
 * Tools, auth controls), styled to sit above a dark editor surface. It is
 * always on screen on an editor route; the editor's own song-identity row
 * renders directly beneath it as a separate, second row.
 *
 ...
 * home, More Tools, auth controls - are the site's standing set, so a new one
 * belongs in both. The Discord / GitHub icon links the full nav carries are
 * not here yet; the owner asked for them (plan 0076 item 1).
 */
