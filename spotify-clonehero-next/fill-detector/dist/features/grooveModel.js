 ...
 */
import { mean, covarianceMatrix, invertMatrix, mahalanobisDistance, regularizeCovariance, identityMatrix } from '../utils/math.js';
/**
 * Creates an empty groove model
 */
export function createEmptyGrooveModel(featureCount) {
    return {
 ...
 */
function extractGrooveFeatures(window) {
 ...
 */
export function updateGrooveModel(model, trainingWindows) {
 ...
 */
export function calculateGrooveDistance(window, model) {
 ...
 */
export function updateGrooveDistances(windows, config) {
    ...
    for (let i = 0; i < windows.length; i++) {
        ...
        windows[i].features.grooveDist = calculateGrooveDistance(windows[i], updatedModel);
    }
}
/**
 ...
 */
export function identifyGrooveWindows(windows, config) {
 ...
 */
export function buildGlobalGrooveModel(windows, config) {
 ...
 */
export function validateGrooveModel(model) {
 ...
 */
export function getModelConfidence(model) {
    if (!model.isValid) {
        return 0;
    }
...
//# sourceMappingURL=grooveModel.js.map