 ...
 */
export function tickToMs(tick, tempos, resolution) {
    if (tempos.length === 0) {
 ...
 */
export function ticksToMsDuration(ticks, bpm, resolution) {
 ...
 */
export function msToDurationTicks(ms, bpm, resolution) {
    const msPerBeat = 60000 / bpm;
 ...
 */
export function getTempoAtTick(tick, tempos) {
    if (tempos.length === 0) {
        throw new Error('No tempo events provided');
    }
    const sortedTempos = [...tempos].sort((a, b) => a.tick - b.tick);
 ...
 */
export function getBpmAtTick(tick, tempos) {
 ...
 */
export function tickRangeToMs(startTick, endTick, tempos, resolution) {
    return {
 ...
 * @returns Duration in milliseconds
 */
export function getTickRangeDurationMs(startTick, endTick, tempos, resolution) {
 ...
 */
export function buildTempoMap(tempos, resolution) {
    if (tempos.length === 0) {
        return [];
    }
    const sortedTempos = [...tempos].sort((a, b) => a.tick - b.tick);
 ...
 */
export function validateTempos(tempos) {
...
//# sourceMappingURL=tempoUtils.js.map