// Built from https://github.com/cutterbl/soundtouchjs-audio-worklet
/*
...
var DEFAULT_SEQUENCE_MS = 82; // Clone Hero bass_fx setting
var USE_AUTO_SEEKWINDOW_LEN = 0;
var DEFAULT_SEEKWINDOW_MS = 28; // Clone Hero bass_fx setting
var DEFAULT_OVERLAP_MS = 8; // Clone Hero bass_fx setting
var _SCAN_OFFSETS = [
  [
...
var Stretch = (function (_AbstractFifoSamplePi2) {
  function Stretch(createBuffers) {
    ...
    _this3._quickSeek = false; // Clone Hero bass_fx setting - disable quick seek for better quality
      ...
      value: function overlapStereo(inputPosition) {
        ...
        for (; i < this.overlapLength; i = i + 1) {
          ...
          output[outputOffset + 0] =
            input[inputOffset + 0] * fi +
            this.midBuffer[context + 0] * tempFrame;
          output[outputOffset + 1] =
            input[inputOffset + 1] * fi +
            this.midBuffer[context + 1] * tempFrame;
        }
      },
    },
    {
...
var getWebAudioNode = function getWebAudioNode(context, filter) {
  var sourcePositionCallback =
    arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : noop;
  var bufferSize =
    arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 4096;
    ...
    [
      {
        ...
        value: function process(inputs, outputs, parameters) {
          ...
          var rightOutput =
            outputs[0].length > 1 ? outputs[0][1] : outputs[0][0];
